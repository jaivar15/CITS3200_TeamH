...
public class Home extends javax.swing.JFrame {
    ...
    private boolean advancedDeviaitons;
    ...
    public Home() {
    	...
    	File f = new File(animalsPath);
    		if(!f.exists())
    		{
    			new File(animalsPath).mkdirs();
    		}
    ...
    private void initComponents() {
        ...
        advanced2 = new javax.swing.JButton();
        ...
        searchVarText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        EmailAccountText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        EmailNameText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        AnimalNameText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        StandDeviationText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        AnimalDescriptionText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        NumberOfDaysText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        DurationLabel.setText("Duration (h)");
        ...
        advanced.setText("Advanced Features");
        ...
        ChangeDurationLabel.setText("Duration(h)");

        ChangeStandDeviationText.setBackground(new java.awt.Color(42, 75, 115));
        ChangeStandDeviationText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ChangeAnimalDescriptionText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ChangeAnimalNameText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ChangeNumberOfDaysText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ChangeDurationText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        advanced2.setText("Advanced Features");
        advanced2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                advanced2MousePressed(evt);
            }
        });
        
        advanced2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                advanced2ActionPerformed(evt);
            }
        });
        changeIdTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    private void advancedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ChangeDev std = new ChangeDev(this);
    ...
    private void advanced2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChangeIDButtonActionPerformed
    	 ChangeDev std = new ChangeDev(this); 
    ...
    private void advanced2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ChangeIDButtonMousePressed
        // TODO add your handling code here:
    ...
    public void actionPerformed() {
            if (checkInput()) {
                try {
                    ...
                    user.backUp();
                    Object[] data = {a.animalName, a.animalDescription, a.deviation, a.days, a.duration, a.filePath, a.orangeDev, a.redDev, a.advancedAlerts};
    ...
    private javax.swing.JButton advanced2;
