...
import swing.serialization;

public class responder {
    private static HashMap<String,HashSet<String>> AnimalNameToEmails;
    ...
    public responder(){
        ...
        user = 0;
        senderEmail = "animal.alert4073@gmail.com";
        senderPass = "Xs-n5a32jX";
    }
    ...
    public final void recover(Object[] o){
        ...
        senderEmail = (String)o[4];
        senderPass = (String)o[5];
    }

    public void backUp(){
        Object[] data = {AnimalNameToEmails,emailToUserName,animalName,emailsToAnimalName, senderEmail, senderPass};
	 ...
	 * @return
	 */
	public static HashSet<String> getEmailsForAnimal(String animalName) {
