...
public class ChangeDeviation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        change.readAnimals(Home.getAnimalsPath());
    ...
    private void updateParameters() {
    	if (checkFields()) {
    		try {
		    	...
		    	Animal a = change.getAnimal(AnimalDropdown.getSelectedItem().toString());
		        ...
		        serialization ser = new serialization(data, Home.getAnimalsPath(), a.animalName);
		        ser.SerializeObject();
