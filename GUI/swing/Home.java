...
public class Home extends javax.swing.JFrame {
    ...
    private static String animalsPath;
     ...
     */
    public Home() {
        animalsPath = new File("").getAbsolutePath().concat("\\src\\GUI\\animals");
        user = new responder();
    ...
    private void setUpModel(){
        Object[] ser = user.readBackUpFile(new File("").getAbsolutePath().concat("\\src\\GUI\\responder.dat"));
        user.recover(ser);
      ...
      //  System.out.println(user.toString());
        ...
        change.readAnimals(animalsPath);
      	...
      	int dataCounter = 0;
      	for (Animal a : change.getAnimals().values()) {
      		animalData[dataCounter][0] = a.animalName;
      		animalData[dataCounter][1] = a.animalDescription;
      		animalData[dataCounter][2] = a.deviation;
      		animalData[dataCounter][3] = a.days;
      		animalData[dataCounter][4] = a.duration;
      		dataCounter++;
      	}
        ...
        changeIdTable.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
            public void valueChanged(ListSelectionEvent event) {
                setChangeAnimal(animalSelected());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        HomeIconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("image\\Home.png"))); // NOI18N
        ...
        SettingIconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("image/Settings.png"))); // NOI18N
        ...
        EmailiconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("image/Send_Email.png"))); // NOI18N
        ...
        ChangeIconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("image/Change.png"))); // NOI18N
        ...
        MainIconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("image/Penguin_48px.png"))); // NOI18N
        ...
        SearchIconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("image/searchs.png"))); // NOI18N
    ...
    public void actionPerformed() {
            if (checkInput()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Please check number fields only contain numbers and animal name is unique");
                }
            }
        }
    ...
    private Animal animalSelected() {
    	return change.getAnimal((String)changeIdTable.getValueAt(changeIdTable.getSelectedRow(), 0));
    }
    ...
    private boolean checkInput() {
        ...
        if (AnimalNameText.getText().equals("") || monitors.containsKey(AnimalNameText.getText())) returnSt = false;
    ...
    private boolean checkInput2() {
        boolean returnSt = true;
        if (ChangeAnimalNameText.getText().equals("") || monitors.containsKey(AnimalNameText.getText())) returnSt = false;
	...
	public static String getAnimalsPath(){
        return animalsPath;
    }
