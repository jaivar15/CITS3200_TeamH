...
public class Home extends javax.swing.JFrame {
    ...
    private void setUpModel(){
        Object[] ser = user.readBackUpFile("/Users/varunjain/Desktop/responder.dat");
        user.recover(ser);
        ...
        addAnimalTable.setModel(new javax.swing.table.DefaultTableModel(
     	...
     	//change.readAnimals("/Users/varunjain/Desktop/GUI/animals");	
    ...
    public void actionPerformed() {
            if (checkInput()) {
                try {
                    ...
                    Object[] data = {a.animalName, a.animalDescription, a.deviation, a.days, a.duration, a.filePath};
                    serialization ser = new serialization(data, "C:\\Users\\jarro\\Documents\\Uni\\Computer Science\\Eclipse\\CITS3200\\animals", a.animalName);
                    ser.SerializeObject();
    ...
    private void addRow(Animal a) {
    	change.readAnimals("C:\\Users\\jarro\\Documents\\Uni\\Computer Science\\Eclipse\\CITS3200\\animals");
    ...
    private void changeRow(Animal a, int row) {
    	change.readAnimals("/Users/varunjain/Desktop/GUI/animals");
